...
from nnunetv2.nets.SwinUMambaD_V1 import get_swin_umamba_d_from_plans
from torchinfo import summary

class nnUNetTrainerSwinUMambaDScratch(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        summary(model, input_size=[1, num_input_channels] + configuration_manager.patch_size, depth=5)
