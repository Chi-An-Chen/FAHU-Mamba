...
from nnunetv2.nets.em_net_model import Spectral_Layer2D # ADD Spectral Layer 
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i in range(depth):
            ...
            self.blocks.append(Spectral_Layer2D(dim=dim))  # 插入 Spectral Layer
...
def load_pretrained_ckpt(
    ...
    ckpt_path = "./data/pretrained/vmamba/vssm_tiny.pth"
):
...
def get_swin_umamba_d_from_plans(
    ...
    print("Loading SwinUMambaD_V1 model from plans")
